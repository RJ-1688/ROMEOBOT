# IF YOU ARE HOSTING RomeoBot ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "RomeoBot_OP")
    MY_GROUP = os.environ.get("YOUR_GROUP", "Romeo_op")
